...
class CI_Security
{
    ...
    protected function _remove_evil_attributes($str, $is_image)
    {
        ...
        foreach ($this->_allowedAttr as $tmpKey => $tmpAttr)
            unset($evil_attributes[array_search($tmpAttr, $evil_attributes)]);
    ...
    {
        $this->_allowedAttr = $allowed['attr'];
        $this->_allowedTags = $allowed['tags'];
    }
